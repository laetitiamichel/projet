...
const container2Carrousel = container2.querySelector(".container2-carrousel");
const carrousel = container2.querySelector(".carrousel");
...
const createCarrousel = () => {
  ...
  container2.style.width = tz * 2 + gap * length + "px";
...
const calculateFov = carrouselProps => {
  const perspective = window
    .getComputedStyle(container2Carrousel)
...
const update = () => {
  ...
  carrousel2.style.setProperty("--rotatey", lastMoveTo + "deg");
...
const onResize = () => {
  ...
  const boundingCarrousel = container2Carrousel.getBoundingClientRect();
...
const initEvents = () => {
  ...
  container2.addEventListener("mouseleave", () => (isMouseDown = false));
